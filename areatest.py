...
#plt.plot(date_bounds, [batcap, batcap], 'k:', linewidth=1)
...
del dE_cor[0]
print(f'{(dE_cor[-1]-batcap)/3600} kWh end year residue ')
...
#plt.text(df.date[min_idx], dE[min_idx]/2, 'Battery Capacity', fontsize=10)
